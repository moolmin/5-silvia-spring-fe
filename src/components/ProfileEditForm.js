...
const ProfileEditForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await fetchWithToken(`${process.env.REACT_APP_API_ENDPOINT}/api/accounts/${fetchedUserId}/nickname`, {
                method: 'PUT',
    ...
    const handleAccountDelete = async () => {
        try {
            const response = await fetchWithToken(`${process.env.REACT_APP_API_ENDPOINT}/api/accounts/${userId}`, {
                method: 'DELETE',
                credentials: 'include'
            });
